...
var _getAccessibilityRole=require('../../modules/getAccessibilityRole');var _getAccessibilityRole2=_interopRequireDefault(_getAccessibilityRole);
...
}}]);return View;}(_react.Component);View.displayName='View';View.defaultProps={accessible:true};View.childContextTypes={isInAButtonView:_propTypes.bool};View.contextTypes={isInAButtonView:_propTypes.bool};process.env.NODE_ENV!=="production"?View.propTypes=_ViewPropTypes2.default:void 0;
